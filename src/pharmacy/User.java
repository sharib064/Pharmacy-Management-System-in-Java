...
public class User extends javax.swing.JFrame {
    ...
    void InsertIntoSql() {
        try {
            ...
            String sql="insert into medorder values('"+jTextField1.getText()+"','"+jTextField2.getText()+"',,'"+jTextField3.getText()+"','"+jTextField4.getText()+"','"+jTextField5.getText()+"')";
            st.execute(sql);
