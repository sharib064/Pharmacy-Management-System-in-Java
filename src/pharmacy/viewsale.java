...
public class viewsale extends javax.swing.JFrame {
    ...
    public viewsale() {
        ...
        try {
            ...
            while(rs.next()){
                ...
                t1=Integer.parseInt(rs.getString(3));
                t2=Integer.parseInt(rs.getString(4));
                ttl=ttl+t1*t2;
                i++;
            }
    ...
    private void initComponents() {
        ...
        total.setFont(new java.awt.Font("Gazpacho Black", 0, 24)); // NOI18N
        total.setForeground(new java.awt.Color(102, 102, 102));
        jPanel2.add(total, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 40, 140, 40));
        ...
        jLabel3.setFont(new java.awt.Font("Gazpacho Black", 0, 24)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(14, 175, 162));
        jLabel3.setText("Total Sales:");
        jPanel2.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 40, 140, 40));
