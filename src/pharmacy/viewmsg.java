 ...
 * @author S
 */
public class viewmsg extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(viewmsg.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
